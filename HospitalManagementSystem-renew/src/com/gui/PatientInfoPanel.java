...
public class PatientInfoPanel extends javax.swing.JPanel {
    ...
    private TreeMap<Integer, Patient> patientRecords = new TreeMap<>();
...
private void loadDataFromFile() {
    try {
        ...
        // Initialize a TreeMap to store key-value pairs of patient data
        ...
        // Extract patient data from the TreeMap and create a Patient object
...
public void SaveToTextFile() {
    ...
    dataTreeMap.put("Age", jFormattedTextFieldAgeEdit.getText());
    dataTreeMap.put("PhoneNo", jFormattedTextFieldPhoneNoEdit.getText());
    dataTreeMap.put("Price", jFormattedTextFieldPrice.getText());
    dataTreeMap.put("RegDate", jFormattedTextFieldRegDateEdit.getText());
    dataTreeMap.put("Gender", (String) jComboBoxGenderEdit.getSelectedItem());
    dataTreeMap.put("Disease", jTextFieldDiseaseEdit.getText());
    dataTreeMap.put("Name", jTextFieldNameEdit.getText());
    dataTreeMap.put("Address", jTextAreaAddressEdit.getText());
    dataTreeMap.put("Comments", jTextAreaCommentsEdit.getText());
    dataTreeMap.put("PatientID", jFormattedTextFieldID.getText());
...
private void saveToFile(TreeMap<String, String> dataTreeMap) {
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        // TODO add your handling code here:
    String patientName = jFormattedTextFieldEditName.getText().trim();
    deleteFile(patientName);
    }//GEN-LAST:event_deleteActionPerformed

private void deleteFile(String patientName) {
        File folder = new File("Patients Records");
        File file = new File(folder, patientName + ".txt");
